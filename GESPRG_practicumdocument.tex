...
Een DOS-box kan je openen via de Start-knop (in het voorbeeld onder Windows 10). Klik op Start en vul in het kader de tekst \lstinline[language=,literate=]|cmd.exe| in. Druk op de enter-toets en een DOS-box wordt geopend. Zie figuur~\ref{fig:cmdexe}.
