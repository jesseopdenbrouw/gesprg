...
\tableofcontents
\vfill
Dit document is gemaakt door F. Theinert, W. Muhammad, B. Kuiper, M. Schrauwen en J. op den Brouw.
...
Een array is een lijst van variabelen van het zelfde type. Je kan een array indexeren. Dat houdt in dat je een \textsl{element} uit de lijst kan gebruiken in je bewerkingen. Hiervoor gebruik je blokhaken.
