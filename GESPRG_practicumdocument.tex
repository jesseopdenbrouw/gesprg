...
%%
%%   GESPRG_practicumdocument - Exercizes for programming in C
%%
...
\begin{itemize}
	\item Open een command-box (Windows: Windowstoets-R en type \lstlisting[language=,literate=]|cmd.exe|, OS-X: start terminal; Linux: start terminal).
...
Het laatste voorbeeld betreft het kopi\"eren van een bestand. We gebruiken de command line argumenten om de bestandsnamen door te geven en bestandsafhandeling om het daadwerkelijke kopi\"eren te realiseren. Het programma is te vinden in listing~\ref{cod:filecopy}.
