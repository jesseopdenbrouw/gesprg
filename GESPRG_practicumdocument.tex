...
\section{Toekenning- en herhalingsopdrachten (\texttt{for} loop)}
...
\begin{itemize}
\item Open een command-box (Windows: Windowstoets-R en type cmd.exe, OS-X: start terminal; Linux: start terminal).
