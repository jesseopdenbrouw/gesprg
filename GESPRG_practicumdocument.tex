...
%%
%%   (c) 2019  --  The Hague University of Applied Sciences (THUAS)
%%
...
Een DOS-box kan je openen via de Start-knop (in het voorbeeld onder Windows 7).  Klik op Start en vul in het kader de tekst \lstinline[language=,literate=]|cmd.exe| in. Druk op de enter-toets en een DOS-box wordt geopend. Zie figuur~\ref{fig:cmdexe}.
